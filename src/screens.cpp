...
void Screens::DisplaySixteenBitSoftScreen(void)
{
    ...
    if (input->CheckKeyCodeName("[D]") == true)
    {
    ...
    if (input->CheckKeyCodeName("[T]") == true)
    {
...
void Screens::DisplayTitleScreen(void)
{
    ...
    if (ScreenIsDirty == true)
    {
        ...
        visuals->DrawTextOntoScreenBuffer("A.I. 24,000+", visuals->Font[2]
        ...
        visuals->DrawTextOntoScreenBuffer("Retail Version 4.5.5", visuals->Font[2]
        ...
        strcat(visuals->VariableText, "2016, By 16BitSoft Inc.");
...
void Screens::DisplayOptionsScreen(void)
{
    if (ScreenTransitionStatus == FadeAll)
    {
        ...
        interface->CreateArrowSet(4, 270);

        interface->CreateArrowSet(5, 345);
     ...
     && input->KeyboardSetupProcess == KeyboardSetupNotStarted)
    {
        ...
        if (interface->ArrowSetArrowSelectedByPlayer != -1)
        {
            if (interface->ArrowSetArrowSelectedByPlayer == 0)
            {
                ...
                if (audio->MusicVolume == 0)  SDL_SetWindowTitle(visuals->Window, "''TetriCrisis 4 110% A.I. Turbo'' - (C)2014 By 16BitSoft Inc.");
    ...
    if (ScreenIsDirty == true)
    {
        ...
        visuals->DrawTextOntoScreenBuffer("Delayed Auto Shift:"
                                          , visuals->Font[0], 60, 270-15, JustifyLeft
                                          , 255, 255, 255, 90, 90, 90);
        if (logic->DelayAutoShift == 0)
            visuals->DrawTextOntoScreenBuffer("Original", visuals->Font[0], 60, 270-15, JustifyRight
                                              , 255, 255, 255, 90, 90, 90);
        else if (logic->DelayAutoShift == 1)
            visuals->DrawTextOntoScreenBuffer("Slow Shift", visuals->Font[0], 60, 270-15, JustifyRight
                                              , 255, 255, 255, 90, 90, 90);
        else if (logic->DelayAutoShift == 2)
            visuals->DrawTextOntoScreenBuffer("Fast Shift", visuals->Font[0], 60, 270-15, JustifyRight
                                              , 255, 255, 255, 90, 90, 90);

        visuals->DrawTextOntoScreenBuffer("_____________________________________"
                                          , visuals->Font[3], 0, 285, JustifyCenter
                                          , 255, 255, 255, 90, 90, 90);
...
void Screens::DisplayHowToPlayScreen(void)
{
    ...
    if (ScreenIsDirty == true)
    {
        ...
        if (input->UserDefinedKeyButtonOne != -1 && input->UserDefinedKeyButtonTwo != -1)
        {
            ...
            input->ConvertScancodeToNameAndChar( input->UserDefinedKeyUP );
            strcpy(visuals->VariableText, input->KeycodeName);
...
void Screens::DisplayHighScoresScreen(void)
{
    ...
    if (input->CheckKeyCodeName("[C]") == true)
    {
...
void Screens::DisplayAboutScreen(void)
{
    ...
    if ( input->CheckKeyCodeName("[Spacebar]") == true
        || input->CheckKeyCodeName("[Return]") == true
...
//    if (ScreenIsDirty == true)
    {
        ...
        if (logic->PAUSEgame == true && input->DEBUG != 1)
        {
            ...
            else
            {
                ...
                strcat(visuals->VariableText, input->KeycodeName);
...
void Screens::DisplayNameInputKeyboardScreen(void)
{
    ...
    if (input->CheckKeyCodeName("[Return]") == true)
    {
    ...
    else if (input->CheckKeyCodeName("[Backspace]") == true)
    {
    ...
    else if (input->CheckKeyCodeName("[Spacebar]") == true)
    {
