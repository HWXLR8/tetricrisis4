...
sprintf(reg, "%c", 0xAE);
    ...
    strcat(textToDisplay, "2014, By 16BitSoft Inc.");
    ...
    if ( LoadStaffTextIntoMemory("''Gift Of Sight'' Artificial Intelligence Engine Programmer:", 0) == false)  return(false);
    if ( LoadStaffTextIntoMemory("''JeZ+Lee''", 255) == false)  return(false);
    ...
    if ( LoadStaffTextIntoMemory("Developed On A:", 0) == false)  return(false);
    strcpy(textToDisplay, "Zotac");
    strcat(textToDisplay, reg);
    strcat(textToDisplay, " ZBox Thin Client Desktop");
    if ( LoadStaffTextIntoMemory(textToDisplay, 255) == false)  return(false);
    if ( LoadStaffTextIntoMemory("(Running Genuine Xubuntu 14.04 L.T.S. 64Bit Linux)", 255) == false)  return(false);
    if ( LoadStaffTextIntoMemory("Tested On A:", 0) == false)  return(false);
    strcpy(textToDisplay, "Dell");
    strcat(textToDisplay, reg);
    strcat(textToDisplay, " XPS 420 Computer System");
    if ( LoadStaffTextIntoMemory(textToDisplay, 255) == false)  return(false);
    strcpy(textToDisplay, "Falcon Northwest");
    strcat(textToDisplay, reg);
    strcat(textToDisplay, " Mach V Computer System");
    if ( LoadStaffTextIntoMemory(textToDisplay, 255) == false)  return(false);
    strcpy(textToDisplay, "Asus");
    strcat(textToDisplay, reg);
    strcat(textToDisplay, " NetBook Computer System");
    if ( LoadStaffTextIntoMemory(textToDisplay, 255) == false)  return(false);
    strcpy(textToDisplay, "PowerSpec");
    strcat(textToDisplay, reg);
    strcat(textToDisplay, " Computer System From 2002");
    if ( LoadStaffTextIntoMemory(textToDisplay, 255) == false)  return(false);
    ...
    if ( LoadStaffTextIntoMemory("''A 110% By JeZ+Lee''", 0) == false)  return(false);
